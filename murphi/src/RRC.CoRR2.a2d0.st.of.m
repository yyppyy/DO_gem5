...
type
    ...
    DirCnt: 0..DIR_COUNT;
    OBJSET_CPU: enum{ CPU0, CPU1, CPU2, CPU3 };
    OBJSET_cacheL1: scalarset(CACHE_L1_COUNT);
    OBJSET_dir: enum{ DIR0, DIR1 };
...
cpus[CPU2].instrs.Queue[0].val = 1 & /*
 * SPDX-FileCopyrightText: Copyright (c) 2024 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
 * SPDX-License-Identifier: LicenseRef-NvidiaProprietary
 *
 * NVIDIA CORPORATION, its affiliates and licensors retain all intellectual
...
cpus[CPU2].instrs.Queue[1].val = 2 & /*
 * SPDX-FileCopyrightText: Copyright (c) 2024 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
 * SPDX-License-Identifier: LicenseRef-NvidiaProprietary
 *
 * NVIDIA CORPORATION, its affiliates and licensors retain all intellectual
...
cpus[CPU3].instrs.Queue[0].val = 2 & /*
 * SPDX-FileCopyrightText: Copyright (c) 2024 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
 * SPDX-License-Identifier: LicenseRef-NvidiaProprietary
 *
 * NVIDIA CORPORATION, its affiliates and licensors retain all intellectual
...
cpus[CPU3].instrs.Queue[1].val = 1 then
        return false;
    endif;
		return true;
      -- match_cnt := 0;
